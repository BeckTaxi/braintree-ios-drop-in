...
+ (NSArray *)allCards
{
    ...
    dispatch_once(&p, ^{
        ...
        BTUIKCardType *visa = [[BTUIKCardType alloc] initWithBrand:BTDropInLocalizedString(CARD_TYPE_VISA)
                                                  securityCodeName:BTDropInLocalizedString(CVV_FIELD_PLACEHOLDER)
                                                          prefixes:@[@"^4\\d*"]];
        BTUIKCardType *mastercard = [[BTUIKCardType alloc] initWithBrand:BTDropInLocalizedString(CARD_TYPE_MASTER_CARD)
        ...
        BTUIKCardType *jcb = [[BTUIKCardType alloc] initWithBrand:BTDropInLocalizedString(CARD_TYPE_JCB)
                                                 securityCodeName:BTDropInLocalizedString(CVV_FIELD_PLACEHOLDER)
                                                         prefixes:@[@"^35\\d*"]];
        BTUIKCardType *amex = [[BTUIKCardType alloc] initWithBrand:BTDropInLocalizedString(CARD_TYPE_AMERICAN_EXPRESS)
                                                  securityCodeName:BTDropInLocalizedString(CID_FIELD_PLACEHOLDER)
                                                          prefixes:@[@"^3[47]\\d*"]
                                                   relaxedPrefixes:nil
                                                validNumberLengths:[NSIndexSet indexSetWithIndex:15]
                                                    validCvvLength:4
                                                      formatSpaces:@[@4, @10]];
        BTUIKCardType *dinersClub = [[BTUIKCardType alloc] initWithBrand:BTDropInLocalizedString(CARD_TYPE_DINERS_CLUB)
                                                        securityCodeName:BTDropInLocalizedString(CVV_FIELD_PLACEHOLDER)
                                                      ...
                                                      validNumberLengths:[NSIndexSet indexSetWithIndex:14]
                                                          validCvvLength:3
                                                            formatSpaces:nil];
        BTUIKCardType *maestro = [[BTUIKCardType alloc] initWithBrand:BTDropInLocalizedString(CARD_TYPE_MAESTRO)
                                                     securityCodeName:BTDropInLocalizedString(CVC_FIELD_PLACEHOLDER)
                                                   ...
                                                   validNumberLengths:[NSIndexSet indexSetWithIndexesInRange:NSMakeRange(12, 8)]
                                                       validCvvLength:3
                                                         formatSpaces:nil];
        BTUIKCardType *unionPay = [[BTUIKCardType alloc] initWithBrand:BTDropInLocalizedString(CARD_TYPE_UNION_PAY)
                                                      securityCodeName:BTDropInLocalizedString(CVN_FIELD_PLACEHOLDER)
                                                              prefixes:@[@"^62\\d*"]
                                                       relaxedPrefixes:nil
                                                    validNumberLengths:[NSIndexSet indexSetWithIndexesInRange:NSMakeRange(16, 4)]
                                                        validCvvLength:3
                                                          formatSpaces:nil];
        BTUIKCardType *hiper = [[BTUIKCardType alloc] initWithBrand:BTDropInLocalizedString(CARD_TYPE_HIPER)
                                                   securityCodeName:BTDropInLocalizedString(CVC_FIELD_PLACEHOLDER)
                                                           prefixes:@[@"^637(095|568|599|609|612)\\d*"]];
        BTUIKCardType *hipercard = [[BTUIKCardType alloc] initWithBrand:BTDropInLocalizedString(CARD_TYPE_HIPERCARD)
                                                       securityCodeName:BTDropInLocalizedString(CVC_FIELD_PLACEHOLDER)
                                                               prefixes:@[@"^606282\\d*"]];
